...
const recentBookings = [
  { id: 1, client: "Mamadou Diallo", service: "Réparation Smartphone", status: "confirmé", date: "2024-02-24", amount: "15 000 CFA" },
  { id: 2, client: "Fatou Sow", service: "Ménage à domicile", status: "en attente", date: "2024-02-23", amount: "8 000 CFA" },
  { id: 3, client: "Aliou Kanté", service: "Cours de mathématiques", status: "confirmé", date: "2024-02-23", amount: "10 000 CFA" },
  { id: 4, client: "Mariama Bah", service: "Coiffure", status: "annulé", date: "2024-02-22", amount: "12 000 CFA" },
  { id: 5, client: "Ousmane Faye", service: "Plomberie", status: "confirmé", date: "2024-02-22", amount: "25 000 CFA" },
];

const topServices = [
  { name: "Réparation Smartphone", bookings: 145, revenue: "2 175 000 CFA" },
  { name: "Ménage à domicile", bookings: 128, revenue: "1 024 000 CFA" },
  { name: "Cours particuliers", bookings: 98, revenue: "980 000 CFA" },
  { name: "Coiffure", bookings: 87, revenue: "1 044 000 CFA" },
];
...
export function AdminDashboard() {
  ...
  return (
    <div className="p-6 lg:p-8 lg:ml-64">
      {/* En-tête */}
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-[#000080]">Tableau de bord Admin</h1>
                ...
                <div key={index} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">{service.bookings} réservations</p>
                    </div>
                  </div>
