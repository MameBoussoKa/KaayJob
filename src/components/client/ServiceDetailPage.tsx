...
const providersData: Record<string, {
  ...
  "provider-1": {
    ...
    totalReviews: 156,
    yearsExperience: 8,
    image: "https://images.unsplash.com/photo-1552058544-f2b08422138a?w=400&q=80&crop=faces&fit=crop",
    hourlyRate: 15000,
    ...
    services: [
      { name: "Installation de Canalisations", price: "À partir de 20 000 FCA" },
      { name: "Réparation de Fuites", price: "À partir de 15 000 FCA" },
      { name: "Nettoyage de Drains", price: "À partir de 12 000 FCA" },
      { name: "Réparation de Chauffe-eau", price: "À partir de 25 000 FCA" },
      { name: "Service d'Urgence", price: "À partir de 30 000 FCA" },
    ],
    reviews: [
  ...
  "provider-2": {
    ...
    totalReviews: 203,
    yearsExperience: 10,
    image: "https://images.unsplash.com/photo-1531746020798-e6953c6e8e04?w=400&q=80&crop=faces&fit=crop",
    hourlyRate: 20000,
    location: "Dakar, Sénégal",
    ...
    services: [
      { name: "Installation Électrique", price: "À partir de 25 000 FCA" },
      { name: "Réparation de Pannes", price: "À partir de 20 000 FCA" },
      { name: "Mise aux Normes", price: "À partir de 50 000 FCA" },
      { name: "Domotique", price: "À partir de 60 000 FCA" },
      { name: "Service d'Urgence", price: "À partir de 35 000 FCA" },
    ],
    reviews: [
  ...
  "provider-3": {
    ...
    services: [
      ...
      { name: "Décoration", price: "À partir de 15 000 FCA" },
      { name: "Rénovation", price: "À partir de 20 000 FCA" },
    ],
    reviews: [
  ...
  "provider-4": {
    ...
    services: [
      { name: "Nettoyage Maison", price: "À partir de 12 000 FCA" },
      { name: "Nettoyage Bureau", price: "À partir de 15 000 FCA" },
      { name: "Nettoyage Fin de Chantier", price: "À partir de 30 000 FCA" },
  ...
  "provider-5": {
    ...
    services: [
      { name: "Meubles sur Mesure", price: "À partir de 60 000 FCA" },
      { name: "Rénovation Meubles", price: "À partir de 30 000 FCA" },
      { name: "Pose de Parquet", price: "À partir de 15 000 FCA" },
      { name: "Fabrication Porte", price: "À partir de 50 000 FCA" },
    ],
    reviews: [
